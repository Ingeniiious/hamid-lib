    ...
    <div className="space-y-3">
      ...
      <div className="mx-auto max-w-xl">
        <input
          ...
          className={`w-full rounded-full border bg-white/50 px-4 py-2 text-center text-sm text-gray-900 placeholder:text-gray-900/30 focus:border-[#5227FF] focus:outline-none focus:ring-2 focus:ring-[#5227FF]/20 disabled:opacity-60 dark:bg-white/5 dark:text-white dark:placeholder:text-white/30 dark:focus:border-[#8B6FFF] dark:focus:ring-[#8B6FFF]/20 ${
            verdict === "correct"
              ? "border-green-500/30"
              : verdict === "partial"
                ? "border-amber-500/30"
