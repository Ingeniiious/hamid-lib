...
const subjects: Record<TemplateType, string> = {
  "signup-otp": "Your Verification Code — Libraryyy",
  "password-reset-otp": "Your Password Reset Code — Libraryyy",
  "account-deletion-otp": "Account Deletion Confirmation — Libraryyy",
};

const bodyText: Record<TemplateType, (code: string) => string> = {
  "signup-otp": (code) =>
    `Welcome to Libraryyy! Your verification code is: ${code}. This code expires in 5 minutes.`,
  "password-reset-otp": (code) =>
    `Your Libraryyy password reset code is: ${code}. This code expires in 5 minutes. If you didn't request this, you can safely ignore this email.`,
    ...
    <tr>
      <td align="center">
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" style="margin-bottom: 24px;">
          <tr>
            <td align="center">
              <img src="https://libraryyy.com/icon-192.png" alt="Libraryyy" height="24" style="display: block; height: 24px; width: auto;" />
            </td>
          </tr>
        </table>
          ...
          <tr>
            <td style="padding: 40px 36px;">
              ...
              <p style="margin: 0 0 28px; font-size: 14px; line-height: 1.6; color: #78716C;">
                If you didn't request this code, you can safely ignore this email. If you need help, contact us at <a href="mailto:support@libraryyy.com" style="color: #78716C; text-decoration: underline;">support@libraryyy.com</a>.
              </p>

              <!-- Sign-off -->
              <p style="margin: 0; font-size: 15px; line-height: 1.6; color: #44403C;">
                Thanks,<br />The Libraryyy Team
              </p>
            </td>
          </tr>
